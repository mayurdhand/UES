...
public class JCTInventory extends HttpServlet implements RiskItConstants{
	 ...
	 protected void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (region == null) {
				...
				out.println("Invalid Region(This Servlet is only for SYD,SIN or TOK)");
				return;
			}
			...
			InventoryFileOperations.getInstance().JCTInventory(sheetNo, region,env, ivRequestMap);
