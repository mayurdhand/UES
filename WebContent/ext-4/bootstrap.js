/*
 * Ext JS 4.1 - JavaScript Library Copyright (c) 2006-2012, Sencha Inc. All
 * rights reserved. licensing@sencha.com
 * 
 * http://www.sencha.com/license
 * 
 * Open Source License
 * ------------------------------------------------------------------------------------------
 * This version of Ext JS is licensed under the terms of the Open Source GPL 3.0
 * license.
 * 
 ...
 * Alternate Licensing
 * ------------------------------------------------------------------------------------------
 * Commercial and OEM Licenses are available for an alternate download of Ext
 * JS. This is the appropriate option if you are creating proprietary
 * applications and you are not prepared to distribute and share the source code
 * of your application under the GPL v3 license. Please visit
 * http://www.sencha.com/license for more details.
 *  --
 * 
